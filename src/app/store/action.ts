...
import { ManagerType, ProfileType, RegisterType, StudentsType } from './type/global.type';
...
export const managerSuccess = createAction(ManagerType.MANAGER_SUCCESS,props<{managers:[]}>());
...
export const studentsSuccess = createAction(StudentsType.STUDENTS_SUCCESS,props<{students:[]}>());
